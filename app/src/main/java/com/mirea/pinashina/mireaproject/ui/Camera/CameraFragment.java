package com.mirea.pinashina.mireaproject.ui.Camera;
...
import com.mirea.pinashina.mireaproject.R;
import com.mirea.pinashina.mireaproject.databinding.FragmentCameraBinding;
        ...
        ActivityResultCallback<ActivityResult> callback = new ActivityResultCallback<ActivityResult>() {
            ...
            public void onActivityResult(ActivityResult result) {
                if (result.getResultCode() == Activity.RESULT_OK) {
                    ...
                    int hight = random.nextInt(400) + 100; // случайное число от 100 до 1000
                    int longe = random.nextInt(400) + 100; // случайное число от 100 до 1000
                    int weight = random.nextInt(400) + 100; // случайное число от 100 до 1000

                    // Формируем строку с информацией о питательных веществах
                    String nutritionInfo = "Размер: Высота - " + hight + ", Длина - " + longe + ", Ширина - " + weight;
