package ru.mirea.pinashiname.securesharedpreferences
...
import ru.mirea.pinashiname.securesharedpreferences.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.imageViewAvatar.setImageResource(R.drawable.pushkin)
