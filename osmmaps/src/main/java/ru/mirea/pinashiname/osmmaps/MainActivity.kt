package ru.mirea.pinashiname.osmmaps
...
import ru.mirea.pinashiname.osmmaps.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun funcAll() {
        ...
        setMarker("Красная площадь", GeoPoint(55.753340, 37.621245))
        setMarker("МИРЭА Юго-Западная", GeoPoint(55.669794, 37.480476))
    }
}